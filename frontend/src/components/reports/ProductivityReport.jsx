...
const coloresEmpleados = ['#424571', '#232050', '#00dced', '#4cc9ff', '#6baaff'];
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ textAlign: 'center' }}>
        <Text children="Cantidad de citas realizadas" color="white" size={{ xs: 20, md: 24 }} align="center" />
      </Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
         <Text children="Empleados" color="white" size={{ xs: 12, md: 14 }} fontWeight="bold" />
      </Box>
